...
const SYSTEM_PROMPT = `You are an expert MUN delegate. Generate a comprehensive cheat sheet as JSON matching this schema exactly:
{
  ...
  "redLines": ["string"],
  "keyArguments": ["string"],
  "allies": ["string - country names ONLY, e.g. 'United States' not 'United States (description)'"],
  "opponents": ["string - country names ONLY, e.g. 'Russia' not 'Russia (description)'"],
  "opponentNotes": "string - prose explanation describing each opponent and why they oppose",
  "votingRecord": "string",
  "draftClauses": ["string"],
